...
**Equipe Joystick**<br/>
- **Laura Nunes Belém:** Confeccionar o joystick e implementar seu firmware.<br/>
- **Raphael Vasconcelos Nunes de Mello:** Implementar o driver para comunicação do joystick com a Raspberry Pi.

**Equipe Robô**<br/>
- **Laura Nunes Belém:** Confeccionar o braço robótico e implementar seu firmware.<br/>
- **William Roberto dos Santos Pereira:** Trabalhar na comunicação Raspberry Pi X Braço Robótico.
- **Caio Cesar Faneco Gonzaga:** Trabalhar na comunicação Raspberry Pi X Braço Robótico.
